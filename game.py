...
def print_board(vx,vy,board_data,mfont):
    ...
    for i in range(10):
        for j in range(10):
            ...
            if board_data[vx+i][vy+j] != 0 and board_data[vx+i][vy+j] < 10:
                screen.blit(text,(x+20-text.get_width()/2,y+20-text.get_height()/2))
...
mfont = pygame.font.Font("BASKVILL.ttf",20)
